            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    <table cellpadding="0" cellspacing="0" align="center" class="es-footer" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#bcb8b1" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <table cellpadding="0" cellspacing="0" align="center" class="es-content" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#efefef" align="center" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <td align="left" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px"><img
                                                                            ...
                                                                            title="Contáctanos"
                                                                            style="display:block;font-size:18px;border:0;outline:none;text-decoration:none;border-radius:100px"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;letter-spacing:0;color:#2D3142;font-size:18px">
                                                                        Le recordamos que su servicio <strong>{{ $serviceData['serviceName'] }}</strong> caduca en una semana, el día <strong>{{ $serviceData['endDate'] }}</p>
                                                                        <p class="urgent">Es necesario tomar accion de manera urgente para así procesar su renovación a tiempo, evitar pérdidas de información y evitar bajas en el servicio.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
...
<![endif]--><!--[if !mso]> --><span class="es-button-border msohide"
                                                                        style="border-style:solid;border-color:#2CB543;background:#ff4438 ;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                                                            ...
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;padding:15px 20px 15px 20px;display:block;background:#ff4438 ;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26.4px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #4114F7;mso-hide:all;padding-left:5px;padding-right:5px;border-color:#ff4438 ">Contáctanos</a></span><!--<![endif]--></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#efefef" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    role="none">
                                    <tr>
                                        <td align="left" class="esdev-adapt-off" data-custom-paddings="true"
                                            style="Margin:0;padding-top:20px;padding-right:40px;padding-bottom:20px;padding-left:40px">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" style="padding:0;Margin:0">
                                                                                <p
                                                                                    ...
                                                                                    En caso de necesitar ayuda contáctanos:<br>WhatsApp: <a href="https://wa.me/593984258842" target="_blank">+593 98 425 8842</a><br>Email: <a href="mailto:dennis.ocana@mindsoft.biz">dennis.ocana@mindsoft.biz</a><br><br></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <img src="https://servicios.mindsoftdev.com/Mindsoft.png"
                                                                        alt="Logo" title="Logo" height="60"

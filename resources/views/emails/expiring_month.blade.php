                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;letter-spacing:0;color:#2D3142;font-size:18px">
                                                                        Le recordamos que su servicio <strong>{{ $serviceData['serviceName'] }}</strong> caduca en un mes, el día <strong>{{ $serviceData['endDate'] }}</p>
                                                                        <p class="urgent">Este es un recordatorio temprano para gestionar su renovación a tiempo.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>

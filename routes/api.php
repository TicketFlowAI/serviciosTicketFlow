...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/reports/technician/{id}/average-score-per-question', [ReportController::class, 'getTechnicianAverageScorePerQuestion'])->middleware('permission:view-technician-reports');
